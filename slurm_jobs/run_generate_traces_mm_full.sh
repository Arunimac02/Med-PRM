...
#SBATCH --job-name=medprm_mm_full
#SBATCH --time=TBD                  # depends on repeat_count decision -- see scripts_mm/3_generate_traces_full.sh
#SBATCH --ntasks=1
...
# --- Run the full-scale generation ---
bash scripts_mm/3_generate_traces_full.sh
